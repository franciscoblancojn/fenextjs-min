...
const useTheme = ({}) => {
    const { setLocalStorage: setTheme, value: theme } = (0, uselocalstoragenextjs_1.useLocalStorage)({
        name: "fenext-theme",
        defaultValue: "auto",
    });
...
const useModalLocalStorage = () => {
     ...
     */
    const { load: loadModal, setLocalStorage: setShowModal, value: valueModal, } = (0, uselocalstoragenextjs_1.useLocalStorage)({
        name: "fenextjs-modal",
        defaultValue: {
            active: false,
            use: false,
...
const SvgTheme = ({ className = "" }) => (react_1.default.createElement("svg", { className: `fenext_svg ${className}`, viewBox: "0 0 209 172", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
    ...
    react_1.default.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M63 23C67.4183 23 71 26.5817 71 31V164C71 168.08 67.9463 171.446 64 171.938V172H63H31H23V164V142V31C23 26.5817 26.5817 23 31 23H63Z", fill: "var(--fenext-svg-theme-bar,#161618)" }),
    react_1.default.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M192 23H78H75H64V34V161V172H75H78H198C204.075 172 209 167.075 209 161V41V34V23H198H192Z", fill: "var(--fenext-svg-theme-bg-content,#242424)" }),
    react_1.default.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M87 33H126C130.971 33 135 37.0294 135 42V173C135 177.971 130.971 182 126 182H87C82.0294 182 78 177.971 78 173V42C78 37.0294 82.0294 33 87 33ZM154 33H193C197.971 33 202 37.0294 202 42V173C202 177.971 197.971 182 193 182H154C149.029 182 145 177.971 145 173V42C145 37.0294 149.029 33 154 33Z", fill: "var(--fenext-svg-theme-col,#313131)" }),
    react_1.default.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M87 51C87 48.7909 88.7909 47 91 47H121C123.209 47 125 48.7909 125 51V57C125 59.2091 123.209 61 121 61H91C88.7909 61 87 59.2091 87 57V51ZM87 72C87 69.7909 88.7909 68 91 68H121C123.209 68 125 69.7909 125 72V97C125 99.2091 123.209 101 121 101H91C88.7909 101 87 99.2091 87 97V72ZM91 110C88.7909 110 87 111.791 87 114V128C87 130.209 88.7909 132 91 132H121C123.209 132 125 130.209 125 128V114C125 111.791 123.209 110 121 110H91ZM87 145C87 142.791 88.7909 141 91 141H121C123.209 141 125 142.791 125 145V154C125 156.209 123.209 158 121 158H91C88.7909 158 87 156.209 87 154V145ZM154 51C154 48.7909 155.791 47 158 47H188C190.209 47 192 48.7909 192 51V57C192 59.2091 190.209 61 188 61H158C155.791 61 154 59.2091 154 57V51ZM154 72C154 69.7909 155.791 68 158 68H188C190.209 68 192 69.7909 192 72V97C192 99.2091 190.209 101 188 101H158C155.791 101 154 99.2091 154 97V72ZM158 110C155.791 110 154 111.791 154 114V128C154 130.209 155.791 132 158 132H188C190.209 132 192 130.209 192 128V114C192 111.791 190.209 110 188 110H158ZM154 145C154 142.791 155.791 141 158 141H188C190.209 141 192 142.791 192 145V154C192 156.209 190.209 158 188 158H158C155.791 158 154 156.209 154 154V145Z", fill: "var(--fenext-svg-theme-line,#404040)" }),
...
const SvgDiscover = ({ className = "" }) => (react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: `fenext_svg ${className}`, viewBox: "0 0 64.676 10.895" },
    ...
    react_1.default.createElement("g", { "data-name": "discover (1)" },
        ...
        react_1.default.createElement("path", { "data-name": "Path 12243", d: "M163.84 215.151a4.4 4.4 0 0 0-1.176-.867 3.263 3.263 0 0 0-4.419 1.868 3.587 3.587 0 0 0 .68 3.852 3.247 3.247 0 0 0 2.583 1.023 3.053 3.053 0 0 0 2.036-.846c.086-.076.168-.154.252-.231.072.04.042.1.043.149v2.019a.2.2 0 0 1-.126.218 5.544 5.544 0 0 1-6.28-1.051 5.24 5.24 0 0 1-1.52-3.682 5.34 5.34 0 0 1 3.8-5.2 5.249 5.249 0 0 1 4.008.314c.07.035.124.065.123.161-.006.742-.004 1.482-.004 2.273z", transform: "translate(-136.089 -212.063)", fill: "#231f20;fill-rule:evenodd" }),
        react_1.default.createElement("path", { "data-name": "Path 12244", d: "M75.54 223.934c0 .169-.024.235-.217.23a34.11 34.11 0 0 0-1.631 0c-.132 0-.173-.032-.172-.168q.006-4.966 0-9.931c0-.149.049-.179.186-.177.537.007 1.074.011 1.611 0 .178 0 .227.039.226.222-.009 1.64-.008 8.19-.003 9.824z", transform: "translate(-64.171 -213.577)", fill: "#231f20;fill-rule:evenodd" }),
        react_1.default.createElement("path", { "data-name": "Path 12245", d: "m503.7 216.536.291.389h-.203a.034.034 0 0 1-.033-.019l-.228-.34c0-.011-.014-.011-.023-.009s-.005.011-.005.017v.333c0 .018-.005.022-.022.022h-.144c-.012 0-.017 0-.017-.016v-.9c0-.01 0-.016.014-.015h.309a.317.317 0 0 1 .194.074.257.257 0 0 1 .08.22.24.24 0 0 1-.195.237zm-.206-.251v.123c0 .014 0 .017.017.017h.081a.132.132 0 0 0 .129-.133.121.121 0 0 0-.088-.131.413.413 0 0 0-.122-.012c-.013 0-.018 0-.018.017v.119z", transform: "translate(-439.313 -215.423)", fill: "#231f20;fill-rule:evenodd" }),
    ...
    const ITEMS = [
        {
            ...
            icon: react_1.default.createElement(exports.SvgTableBox, null),
        },
        {
            id: "fenext-swich-view-table-list",
            icon: react_1.default.createElement(exports.SvgTableList, null),
        },
    ];
    ...
    const ITEMS = [
        {
            ...
            icon: react_1.default.createElement(exports.SvgSelectBox, null),
        },
        {
            id: "fenext-swich-view-select-list",
            icon: react_1.default.createElement(exports.SvgSelectList, null),
        },
        {
            id: "fenext-swich-view-select-normal",
            icon: react_1.default.createElement(exports.SvgSelectNormal, null),
        },
    ];
...
const InputNumberCount = ({ onChange, value: valueProps = undefined, defaultValue, symbolInit = "$", symbolFinal = "", validator: validatorProps = undefined, min = -Infinity, max = Infinity, minError, maxError, optionsParseNumber, aplyMax = true, aplyMin = false, ...props }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(exports.InputText, { ...props, className: `fenext-input-number-count ${props?.className ?? ""}`, 
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: `fenext-input-rate ${className} `, style: {
            ...
            react_1.default.createElement("div", { className: `fenext-input-rate-content-start ${classNameContentStar} ` },
                react_1.default.createElement(exports.SvgStar, { className: `fenext-input-rate-start ${classNameStar}` }),
                react_1.default.createElement(exports.SvgStar, { className: `fenext-input-rate-start ${classNameStar}` }),
                react_1.default.createElement(exports.SvgStar, { className: `fenext-input-rate-start ${classNameStar}` }),
                react_1.default.createElement(exports.SvgStar, { className: `fenext-input-rate-start ${classNameStar}` }),
                react_1.default.createElement(exports.SvgStar, { className: `fenext-input-rate-start ${classNameStar}` })),
            react_1.default.createElement("div", { className: `fenext-input-rate-content-start fenext-input-rate-content-start-active ${classNameContentStar} ` },
                react_1.default.createElement(exports.SvgStar, { className: `fenext-input-rate-start fenext-input-rate-start-active ${classNameStar} ${classNameStarActive}` }),
                react_1.default.createElement(exports.SvgStar, { className: `fenext-input-rate-start fenext-input-rate-start-active ${classNameStar} ${classNameStarActive}` }),
                react_1.default.createElement(exports.SvgStar, { className: `fenext-input-rate-start fenext-input-rate-start-active ${classNameStar} ${classNameStarActive}` }),
                react_1.default.createElement(exports.SvgStar, { className: `fenext-input-rate-start fenext-input-rate-start-active ${classNameStar} ${classNameStarActive}` }),
                react_1.default.createElement(exports.SvgStar, { className: `fenext-input-rate-start fenext-input-rate-start-active ${classNameStar} ${classNameStarActive}` })),
        ...
        react_1.default.createElement("div", { className: `fenext-input-phone ${classNamePhone}` },
            ...
            react_1.default.createElement("div", { className: `fenext-input-phone-code ${classNamePhoneCode}` },
                react_1.default.createElement(exports.InputSelectT, { ...classNameSelectCode, classNameList: `fenext-input-phone-select-code ${classNameSelectCode?.classNameList ?? ""}`, key: `${defaultValue?.code_country}-${defaultValue?.code}-${value?.code}-${phones.length}`, placeholder: placeholderCode, _t: _t, options: phones, onParse: (e) => {
                    ...
                    optional: false, showOptionIconImg: true, itemMaxLengthShowOptions: {
                        id: "fenext-item-max-length-show-options",
                        text: "...",
                    } })),
...
const InputSelectCSC = ({ classNameSelectCSC = "", useContainer = true, country = {
    ...
    const CONTENT = (0, react_1.useMemo)(() => {
        let C = (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(exports.InputSelectT, { ...props, ...country, useTOption: false, options: countrys, nItems: countrys.length, onChange: onChangeCSC("country"), defaultValue: value?.country, loader: !loadCountrys, onParse: (e) => {
                    return {
                        ...e,
                        id: e?.id ?? "",
                        text: e?.text ?? "",
...
const InputSelectCountryMultiple = ({ ...props }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(exports.InputSelectMultipleT, { ...props, useTOption: false, options: options, loader: loader, useLoader: true, onParse: (e) => ({
                ...e,
                text: e?.text ?? "",
                id: e?.id ?? "",
                data: e,
...
const DropDown = ({ classNameDropDown = "", show = "focus", ...props }) => {
    ...
    const onDefDropDownPos = () => {
        if (dropDownRef.current) {
            setSpaces((0, exports.GetSpaceParent)(dropDownRef.current));
        }
    };
    (0, react_1.useEffect)(() => {
        onDefDropDownPos();
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { ref: dropDownRef, className: `fenext-dropdown fenext-dropdown-${spaces.spaceRight > spaces.spaceLeft ? "left" : "right"} fenext-dropdown-${spaces.spaceTop > spaces.spaceBottom ? "up" : "down"} ${classNameDropDown} `, style: {
            ...
            react_1.default.createElement(exports.Collapse, { ...props, show: show }))));
};
