...
exports.CONFIG = {
    EMPY: (0, exports.getProcessEnv)("NEXT_PUBLIC_EMPY") == "TRUE",
    MODATA: (0, exports.getProcessEnv)("NEXT_PUBLIC_MODATA") == "TRUE",
    LOG: (0, exports.getProcessEnv)("NEXT_PUBLIC_LOG") == "TRUE",
};
...
const useHistory = ({ name = "fenextjs-history", useRouterCustom = exports.useRouter, }) => {
...
const useRefresh = ({ ...props }) => {
    const { data, onConcatData } = (0, exports.useData)({}, {
        ...props,
...
const useApiError = ({ onActionExecute }) => {
    const { onAction: onApiError } = (0, exports.useAction)({
        name: "api-error",
        onActionExecute,
    });
    return { onApiError };
...
const useApiQuery = ({ url, options, input, key, useUserToken = true, usedataFilter = true, usepagination = true, }) => {
    const { user, load } = (0, exports.useUser)({});
    const { data: dataFilter } = (0, exports.useFilter)({});
    const { data: pagination } = (0, exports.usePagination)({});
    const { onApiError } = (0, exports.useApiError)({});
    const { data: { [key]: _key }, } = (0, exports.useRefresh)({});
    const onQuery = async () => {
...
exports.FenextImgPlaceholderUrlBase = "https://fenextjs-img-placeholder.vercel.app";
exports.FenextImgUserPlaceholder = `${exports.FenextImgPlaceholderUrlBase}/user.png`;
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: `
            ...
            react_1.default.createElement("div", { className: "fenext-chat-message-info" },
                ...
                react_1.default.createElement(exports.Text, { loader: loader, className: "fenext-chat-message-message" },
                    message,
                ...
                file && (react_1.default.createElement(react_1.default.Fragment, null,
                    react_1.default.createElement("div", { className: "fenext-chat-message-file" },
                        react_1.default.createElement(exports.InputUpload, { defaultValue: file, disabled: true }))))))));
};
exports.ChatMessage = ChatMessage;
const ChatFormSendMessage = ({ useSubmitInEnter = true, btnChildren = react_1.default.createElement(exports.SvgSend, null), btnFileChildren = react_1.default.createElement(exports.SvgPaperClip, null), placeholderMessage = "Message", InputFileProps = {}, ...props }) => {
    const { _t } = (0, exports.use_T)({ ...props });
    const ref = (0, react_1.useRef)(null);
    const [__key, set__key] = (0, react_1.useState)(0);
    const { data, setData, onChangeData, loaderSubmit, onSubmitData } = (0, exports.useData)({}, {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: "fenext-chat-form-send-message", ref: ref },
            react_1.default.createElement(exports.InputText, { classNameLabel: "fenext-chat-form-send-message-label", type: "textarea", placeholder: _t(placeholderMessage), className: "fenext-chat-form-send-message-input-message", onChange: onChangeData("message"), value: data.message ?? "", onEnter: () => {
            ...
            react_1.default.createElement("div", { className: "fenext-chat-form-send-message-content-btn" },
                react_1.default.createElement(exports.Button, { loader: loaderSubmit || props?.loader, disabled: !data.message || data.message == "", _t: _t, size: "extra-small" }, btnChildren),
                react_1.default.createElement(exports.InputFile, { ...InputFileProps, key: __key, onChange: (e) => {
                        onSubmitData({
                            data: {
                                ...data,
                                file: e,
                    ...
                    react_1.default.createElement(exports.Button, { loader: loaderSubmit || props?.loader, _t: _t, size: "extra-small" }, btnFileChildren))))));
};
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(Tag, { onClick: disabled ? onClickDisabled : onClick, className: `
            ...
            loader && (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement("div", { className: `fenext-btn-content-loader-element ${classNameContentLoaderElement}` }, iconLoader ?? (react_1.default.createElement(exports.Loader, { classNameLoader: `fenext-btn-loader-element ${classNameLoaderElement}` }))))),
            icon,
            _t(children))));
};
...
const InputGoogleLoadScript = ({ googleMapsApiKey = undefined, children, className = "", _t, useT, ...props }) => {
    ...
    return (react_1.default.createElement("div", { className: `fenext-input-google-load-script ${className}` },
        react_1.default.createElement(api_1.LoadScript, { ...props, googleMapsApiKey: googleMapsApiKey ?? (0, exports.getProcessEnv)("NEXT_PUBLIC_GOOGLE_KEY") ?? "", libraries: ["places", "geometry", "marker"], onError: () => {
...
const Table = ({ classNameContent = "", classNameContentTable = "", classNameTable = "", classNameTHead = "", classNameTBody = "", classNameThr = "", classNameTr = "", classNameTh = "", classNameTd = "", classNameTdLabelCollapse = "", classNameContentPagination = "", classNameLoader = "", name, items, header, error, nItems, pagination, showPagination = true, loader = false, typeLoader = "line", useCheckbox = true, onOrderBy, restartPaginationInRenderTable = true, onChecked, notResult = react_1.default.createElement("div", null, "There is not results"), actionsCheckbox, actionsCheckboxSelectAll = "Select All", ...props }) => {
    const { _t } = (0, exports.use_T)({ ...props });
    const { setData } = (0, exports.usePagination)({
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { ref: ref, className: `
            ...
            react_1.default.createElement("div", { className: `fenext-steps-content-btn ${classNameContentBtn} ` },
                (currentStep != 0 || forceShowBtnPrev) && (react_1.default.createElement(exports.Button, { className: `fenext-steps-btn fenext-steps-btn-prev ${classNameBtn} ${classNameBtnPrev}`, classNameDisabled: `${classNameBtnDisabled} ${classNameBtnPrevDisabled}`, disabled: disabledBtnPrev || currentStep == 0, onClick: onPrev_, onClickDisabled: onPrevDisabled, loader: loader, _t: _t }, btnPrev)),
...
exports.User = User;
const Img = ({ className = "", classNameImg = "", id, name = "", alt, src, srcMin1920 = undefined, srcMin1680 = undefined, srcMin1440 = undefined, srcMin1024 = undefined, srcMin992 = undefined, srcMin768 = undefined, srcMin575 = undefined, imgIf404 = exports.FenextImgPlaceholder, layers = [], onErrorImg: onErrorImg_, onClick, loader = false, onLoad, }) => {
    const onErrorImg = (e) => {
        const img = e.target;
        if (imgIf404) {
            img.src = imgIf404;
