...
export declare const useFilter: <CF extends Record<string, any> = any>({ name, onChage, }: useFilterProps<CF>) => {
    ...
    onChangeData: (id: "search" | "date" | keyof CF) => (value: useFilterDataProps<CF>["search" | "date" | keyof CF], _options?: onChangeDataOptionsProps<useFilterDataProps<CF>> | undefined) => void;
...
export declare const useData: <T, M = any, RT = void, RM = void, ET = any, EM = any>(defaultData: T, options?: useDataOptions<T, M, RT, RM, ET, EM> | undefined) => {
    ...
    onSubmitData: (optionsSubmitData?: {
        data?: T | undefined;
        overwrite?: {
            onSubmitData?: ((data: T) => RT | Promise<RT>) | undefined;
        } | undefined;
        onSaveData?: ((p: {
            data: T;
            result: RT;
    ...
    onSubmitDataMemo: (optionsSubmitDataMemo?: {
        dataMemo?: M | undefined;
        overwrite?: {
            onSubmitDataMemo?: ((data: M) => RM | Promise<RM>) | undefined;
        } | undefined;
        useValidatorMemo?: boolean | undefined;
